  ...
  <div class="menu-wrapper">
    <div class="navigation-wrapper">
      <div class="navigation-content">
        ...
        <div class="menu-item _03"><a href="/labs/bhaskaracharya" aria-current="page" class="button-with-line w-inline-block w--current">
            <div class="button-text-wrapper">
    ...
    <div id="Hero" class="cloud-hero-wrapper">
      ...
      <div class="cloud-content-container">
        ...
        <div class="cloud-emblem-wrap">
          <img
            ...
            alt="Bhaskaracharya Lab"
            class="cloud-floating-emblem"
          />
        </div>
      ...
      <div class="container-bottom hero-bottom-bar">
        <div class="bottom-grid _2 hero-bottom-grid">
          <div>
            <p class="top-text big">DOMAIN <span class="lighter-color" style="color: #34D399;">/ CLOUD &amp; DISTRIBUTED SYSTEMS</span></p>
          </div>
          <div class="hide-mobile">
            <p class="top-text big hero-domain-tags">KUBERNETES &bull; SERVERLESS &bull; NEXT.JS &bull; EDGE ARCHITECTURE</p>
          </div>
          <div class="hero-scroll-explore">
            <p class="top-text"><span class="_w-logo arrow">W</span> &nbsp;System Architecture</p>
          </div>
        </div>
      </div>
      ...
      <section id="Mission" class="editorial-section">
        <div class="editorial-container">
          ...
          <div class="editorial-split-layout" data-scroll-fade>
            ...
            <div class="editorial-left-col">
              ...
              <h2 class="about-title effect split-reveal section-title-heading">
                Cloud<br class="hide-mobile-break" />Charter
              </h2>
            </div>
            ...
            <div class="editorial-right-col">
              ...
              <div class="editorial-statement-block">
                <div class="statement-overline">
                  <span class="statement-index">05</span>
                  <span class="statement-tag" style="color: #34D399;">SCALABLE INFRASTRUCTURE</span>
                </div>
                <h3 class="editorial-quote-text">
                  &ldquo;To advance web technologies and cloud computing through innovative research in scalable architectures, distributed systems, and modern web frameworks. We empower students to bridge the gap between design and engineering, crafting high-performance, accessible, and resilient digital solutions that power the future of the internet.&rdquo;
                </h3>
              </div>
              ...
              <div class="cloud-vectors-grid">
                <div class="cloud-vector-col">
                  ...
                  <h4 class="cloud-vector-title">Distributed Cloud Platforms</h4>
                  <p class="cloud-vector-desc">Deploying fault-tolerant microservice clusters, auto-scaling Kubernetes workloads, and edge compute nodes.</p>
                </div>
                <div class="cloud-vector-col">
                  <span class="cloud-vector-num">02. FRONTEND</span>
                  <h4 class="cloud-vector-title">Modern Web Engineering</h4>
                  <p class="cloud-vector-desc">Crafting high-throughput React/Next.js client applications with sub-100ms render performance and rich interactions.</p>
                </div>
                <div class="cloud-vector-col">
                  <span class="cloud-vector-num">03. BACKEND</span>
                  <h4 class="cloud-vector-title">Resilient APIs &amp; Data</h4>
                  <p class="cloud-vector-desc">Architecting event-driven pipelines, streaming WebSocket backends, and zero-latency caching networks.</p>
                </div>
              </div>
          ...
          <div class="editorial-metrics-row" data-scroll-fade>
            ...
            <div class="metric-cell">
              <div class="metric-big-num">08</div>
              <p class="metric-desc">Team Members</p>
            </div>
            <div class="metric-cell">
              <div class="metric-big-num">99.9%</div>
              <p class="metric-desc">Uptime Standard</p>
            </div>
            <div class="metric-cell">
              <div class="metric-big-num">100%</div>
              <p class="metric-desc">Student Scaled</p>
            </div>
          </div>
...
const HEAD_STYLES = `
  *, *::before, *::after {
  ...
  /* =========================================================
     LAB 05 // BHASKARACHARYA: DISTRIBUTED CLOUD ARCHITECTURE
     ========================================================= */
  ::selection {
  ...
  .cloud-ambient-glow {
    ...
    background: radial-gradient(circle, rgba(16, 185, 129, 0.28) 0%, rgba(16, 185, 129, 0.05) 50%, transparent 75%);
    border-radius: 50%;
    pointer-events: none;
    z-index: 2;
    filter: blur(25px);
    animation: cloudAuraPulse 6s ease-in-out infinite alternate;
  }

  @keyframes cloudAuraPulse {
  ...
  .cloud-floating-emblem {
    width: clamp(85px, 11vw, 125px);
    height: auto;
    filter: drop-shadow(0 0 30px rgba(16, 185, 129, 0.6)) drop-shadow(0 15px 40px rgba(0, 0, 0, 0.95));
    animation: cloudSoftFloat 6s ease-in-out infinite alternate;
  }
  ...
  /* 3 Cloud Vectors (Open Columns, No Boxes) */
  .cloud-vectors-grid {
    display: grid;
