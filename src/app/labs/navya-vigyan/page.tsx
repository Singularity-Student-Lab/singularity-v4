  ...
  <div class="menu-wrapper">
    <div class="navigation-wrapper">
      <div class="navigation-content">
        ...
        <div class="menu-item _03"><a href="/labs/navya-vigyan" aria-current="page" class="button-with-line w-inline-block w--current">
            <div class="button-text-wrapper">
    ...
    <div id="Hero" class="modernist-hero-wrapper">
      ...
      <div class="modernist-content-container">
        ...
        <div class="modernist-emblem-wrap">
          <img
            ...
            alt="Navya Vigyan Lab"
            class="modernist-floating-emblem"
          />
        </div>
      ...
      <div class="container-bottom hero-bottom-bar">
        <div class="bottom-grid _2 hero-bottom-grid">
          <div>
            <p class="top-text big">DOMAIN <span class="lighter-color" style="color: #F87171;">/ INTERDISCIPLINARY SYNTHESIS</span></p>
          </div>
          <div class="hide-mobile">
            <p class="top-text big hero-domain-tags">RESEARCH STRATEGY &bull; VENTURE ARCHITECTURE &bull; CROSS-DISCIPLINE</p>
          </div>
          <div class="hero-scroll-explore">
            <p class="top-text"><span class="_w-logo arrow">W</span> &nbsp;Explore Manifesto</p>
          </div>
        </div>
      </div>
      ...
      <section id="Mission" class="editorial-section">
        <div class="editorial-container">
          ...
          <div class="editorial-split-layout" data-scroll-fade>
            ...
            <div class="editorial-left-col">
              ...
              <h2 class="about-title effect split-reveal section-title-heading">
                Synthesis<br class="hide-mobile-break" />Charter
              </h2>
            </div>
            ...
            <div class="editorial-right-col">
              ...
              <div class="editorial-statement-block">
                <div class="statement-overline">
                  <span class="statement-index">07</span>
                  <span class="statement-tag" style="color: #F87171;">MODERN SCIENCE MANIFESTO</span>
                </div>
                <h3 class="editorial-quote-text">
                  &ldquo;To pioneer breakthrough innovations through interdisciplinary research, experimental engineering, and strategic management. We empower students to connect diverse fields of study, translate research into real-world applications, and develop the leadership needed to navigate and shape emerging technological frontiers.&rdquo;
                </h3>
              </div>
              ...
              <div class="modernist-vectors-grid">
                <div class="modernist-vector-col">
                  ...
                  <h4 class="modernist-vector-title">Venture Architecture</h4>
                  <p class="modernist-vector-desc">Transforming fundamental academic research into scalable technological ventures, IP strategies, and product roadmaps.</p>
                </div>
                <div class="modernist-vector-col">
                  <span class="modernist-vector-num">02. SYNTHESIS</span>
                  <h4 class="modernist-vector-title">Cross-Disciplinary Prototyping</h4>
                  <p class="modernist-vector-desc">Fusing biology, AI, physics, and distributed systems to build experimental prototypes that transcend single-field limits.</p>
                </div>
                <div class="modernist-vector-col">
                  <span class="modernist-vector-num">03. LEADERSHIP</span>
                  <h4 class="modernist-vector-title">Scientific Leadership</h4>
                  <p class="modernist-vector-desc">Directing inter-lab coordination, research ethics, grant pipelines, and publication governance across Singularity.</p>
                </div>
              </div>
          ...
          <div class="editorial-metrics-row" data-scroll-fade>
            ...
            <div class="metric-cell">
              <div class="metric-big-num">01</div>
              <p class="metric-desc">Executive</p>
            </div>
            <div class="metric-cell">
              <div class="metric-big-num">&infin;</div>
              <p class="metric-desc">Intersections</p>
            </div>
            <div class="metric-cell">
              <div class="metric-big-num">100%</div>
              <p class="metric-desc">Student Led</p>
            </div>
          </div>
          ...
          <div class="editorial-split-layout" data-scroll-fade style="margin-bottom: 4rem;">
            ...
            <div class="editorial-right-col">
              ...
              <div class="editorial-leader-row">
                <p class="leader-category-tag" style="color: #F87171;">LAB EXECUTIVE</p>
                <div class="leader-profile-unit">
                  <img
                    src="https://res.cloudinary.com/dtlder1hw/image/upload/v1787073656/team/supreet.png"
                    alt="Supreet Kothuri"
                ...
                <div class="editorial-hairline" style="margin: 2.5rem 0 1.8rem 0;"></div>

                <p class="editorial-quote-text" style="font-size: 1.15rem; line-height: 1.7; color: rgba(255, 255, 255, 0.9);">
                  &ldquo;Navya Vigyan Lab serves as the catalyst across Singularity's research ecosystem — aligning deep technical investigations with product strategy, organizational velocity, and high-impact cross-disciplinary discovery.&rdquo;
                </p>
              </div>
...
const HEAD_STYLES = `
  *, *::before, *::after {
  ...
  /* =========================================================
     LAB 07 // NAVYA VIGYAN: MONUMENTAL MODERN SCIENCE
     ========================================================= */
  ::selection {
  ...
  .modernist-ambient-glow {
    ...
    background: radial-gradient(circle, rgba(239, 68, 68, 0.28) 0%, rgba(239, 68, 68, 0.05) 50%, transparent 75%);
    border-radius: 50%;
    pointer-events: none;
    z-index: 2;
    filter: blur(25px);
    animation: modernistAuraPulse 6s ease-in-out infinite alternate;
  }

  @keyframes modernistAuraPulse {
    0% { transform: translate(-50%, -50%) scale(0.9); opacity: 0.6; }
    100% { transform: translate(-50%, -50%) scale(1.18); opacity: 0.95; }
  }

  .modernist-content-container {
    position: relative;
    z-index: 10;
    max-width: 960px;
    width: 100%;
  ...
  .modernist-emblem-wrap {
    position: relative;
    margin-bottom: 1.5rem;
  }

  .modernist-floating-emblem {
    width: clamp(85px, 11vw, 125px);
    height: auto;
    filter: drop-shadow(0 0 30px rgba(239, 68, 68, 0.6)) drop-shadow(0 15px 40px rgba(0, 0, 0, 0.95));
    animation: modernistSoftFloat 6s ease-in-out infinite alternate;
  }

  @keyframes modernistSoftFloat {
    0% { transform: translateY(0px); }
    100% { transform: translateY(-14px); }
  }

  .modernist-taxonomy-bar {
    display: inline-flex;
    align-items: center;
    gap: 0.8rem;
  ...
  .modernist-tag-divider {
    color: rgba(255, 255, 255, 0.3);
  }

  .modernist-field-text {
  ...
  /* 3 Modernist Vectors (Open Columns, No Boxes) */
  .modernist-vectors-grid {
    display: grid;
  ...
  /* LEAD PROFILE (Open Editorial Layout, No Boxes) */
...
export default function NavyaVigyanLabPage() {
