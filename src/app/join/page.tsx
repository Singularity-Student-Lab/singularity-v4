  ...
  <div class="menu-wrapper">
    <div class="navigation-wrapper">
      <div class="navigation-content">
        ...
        <div class="menu-item _03"><a href="/join" aria-current="page" class="button-with-line w-inline-block w--current">
            <div class="button-text-wrapper">
            ...
            <div class="editorial-right-col">
              ...
              <div class="status-announcement-card">
                ...
                <div class="status-social-actions">
                  ...
                  >
                    <img width="20" loading="lazy" alt="Instagram" src="/images/instagram-20-5-.webp" class="status-social-icon" />
